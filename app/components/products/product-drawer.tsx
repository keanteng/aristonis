...
export default function ProductDrawer({ product, isOpen, onClose }: ProductDrawerProps) {
    return (
        <div className={`fixed top-0 right-0 z-20 h-screen transition-all duration-500 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} bg-white shadow-lg w-full sm:w-80 md:w-96`}>
